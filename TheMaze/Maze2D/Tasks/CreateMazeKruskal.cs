...
{
    public class CreateMazeKruskal: AbstractCreateMazeTask
    {
        public override void SetCommand(string[] s, int index)
        {
            try
            {
                ...
                AbstractCreateMaze = new KruskalAlgorithem<Cell, int, Position>();
                NumberOfTask = index;
            }
            catch (Exception)
            {
        ...
        public CreateMazeKruskal(IModel m) : base(m)
        {
        }
    }
}
